...
### Проделанная работа:
1. Выбран Tkinter как фреймворк
2. Созданы 3 файла для расчётов каждой фигуры
3. Реализована основная программа с графическим интерфейсом
4. Реализовано сохранение результатов
