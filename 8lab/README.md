...
Классическая игра «Крестики-нолики» с графическим интерфейсом. Два игрока по очереди ставят крестики и нолики на поле 3×3. Побеждает тот, кто первым выстроит три своих символа в ряд. Если все клетки заполнены, а победителя нет — объявляется ничья.
...
Далее запуск main.py

## Краткая справка:
Управление:

    - Ход игрока — кликните левой кнопкой мыши по любой пустой клетке на поле

    - Новая игра — нажмите кнопку «Новая игра» для сброса текущей партии

    - Выход — нажмите кнопку «Выход» или закройте окно
...
Правила:
    ...
    - Побеждает тот, кто первым соберёт три своих символа в линию

    - Если все 9 клеток заполнены и нет победителя — ничья
