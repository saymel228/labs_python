...
### Проделанная работа:
1. Kivy как фреймворк(следующий по списку после Tkinter)
2. Создан абстрактный базовый класс GeometryBody 
3. Построена иерархия наследования: Parallelepiped, Tetrahedron, Sphere наследуют GeometryBody
4. обавлены dunder-методы
    - Parallelepiped: __add__, __mul__
    - Tetrahedron: __sub__, __pow__
    - Sphere: __truediv__, __contains__
5. Экспорт в .docx и .xlsx
...
### Источники:
[Kivy: создание кроссплатформенных Python-приложений для всех ОС](https://sky.pro/wiki/python/kivy-razrabotka-krossplatformennyh-prilozhenij-na-python/)
